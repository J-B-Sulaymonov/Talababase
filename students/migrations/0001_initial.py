...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('contract_type', models.CharField(choices=[('modul', 'Kredit-modul'), ('contract', "To'lov-shartnoma")], default='contract', max_length=10, verbose_name="To'lov maqsadi")),
                ...
                ('grant_type', models.CharField(choices=[('none', 'Imtiyoz yo‘q'), ('CR', 'Iqtidorli talabalar (25%)'), ('MT', 'Faol talabalar (15%)'), ('QH', 'Qurbon Hayiti'), ('QB', 'Qabul'), ('XM', 'Xodimlar'), ('IH', 'Ijtimoiy himoya')], default='none', max_length=10, verbose_name='Ichki grant turi')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=50, null=True, verbose_name="Yo'nalish kodi")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('education_type', models.CharField(choices=[('grant', 'Davlat granti'), ('contract', 'To‘lov-shartnoma')], default='contract', max_length=20, verbose_name="To'lov shakli")),
                ...
                ('phone_number_2', models.CharField(blank=True, max_length=50, null=True, verbose_name='Telefon raqami 2')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=255, verbose_name='Fan nomi')),
            ],
            options={
                'verbose_name': 'Fan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tsch_by_whom', models.CharField(blank=True, choices=[('du', 'Diplomat University'), ('student', 'Talaba')], default='du', max_length=20, null=True, verbose_name='TSCH kim tomonidan')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_summ', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name="To'lov summasi")),
                ('payment_date', models.DateField(blank=True, default=django.utils.timezone.now, null=True, verbose_name="To'lov sanasi")),
                ('status', models.CharField(choices=[('yopildi', 'Yopildi'), ('yopilmadi', 'Yopilmadi'), ('jarayonda', 'Jarayonda')], default='jarayonda', max_length=15, verbose_name='Holati')),
                ...
                ('contract', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='students.contract', verbose_name='Shartnoma')),
